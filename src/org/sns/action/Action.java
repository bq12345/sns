 ...
 * assist users. You are free to create POJOs that honor the same contract
...
public interface Action {
	 ...
	 * 
	 * @return a string representing the logical result of the execution. See
	 *         constants in this interface for a list of standard result values.
	 * @throws Exception
	 *             thrown if a system level exception occurs. <b>Note:</b>
